        ...
        <div className="container-premium">
          <div className="max-w-4xl mx-auto text-center fade-in">
            ...
            <p className="text-xl leading-relaxed text-white/90 mb-12">
              Dispositions, capital markets, and valuation services. Unlock liquidity with precision through institutional-grade transaction execution.
            </p>
            ...
            <Link 
              ...
              onClick={() => {
                trackButtonClick('partner_with_hhp_cta', 'investment_capital_markets_hero');
