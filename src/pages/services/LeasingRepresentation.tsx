        ...
        <div className="container-premium">
          <div className="max-w-4xl mx-auto text-center fade-in">
            ...
            <p className="text-xl leading-relaxed text-white/90 mb-12">
              Strategic leasing solutions for landlords and tenants. We accelerate lease-up, optimize tenant mix, and secure the right space for occupiers.
            </p>
            ...
            <Link 
              ...
              onClick={() => {
                trackButtonClick('partner_with_hhp_cta', 'leasing_representation_hero');
