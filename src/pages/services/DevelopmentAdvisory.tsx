        ...
        <div className="container-premium">
          <div className="max-w-4xl mx-auto text-center fade-in">
            ...
            <p className="text-xl leading-relaxed text-white/90 mb-12">
              Site planning, entitlements, and ground-up execution. From dirt to delivery, done right with disciplined project management and strategic oversight.
            </p>
            ...
            <Link 
              ...
              onClick={() => {
                trackButtonClick('partner_with_hhp_cta', 'development_advisory_hero');
